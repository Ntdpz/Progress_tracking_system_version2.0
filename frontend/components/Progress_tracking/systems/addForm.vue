      ...
      <v-card-text>
        <v-form ref="form" @submit.prevent="submitForm">
          ...
          <v-row>
              ...
              >
                <template v-slot:label>
                  <span class="label-text"
                    >Screen Code <span class="required-asterisk">*</span></span
                  >
                </template>
              </v-text-field>
            </v-col>
            <v-col cols="6">
              ...
              >
                <template v-slot:label>
                  <span class="label-text"
                    >Screen Name <span class="required-asterisk">*</span></span
                  >
                </template>
              </v-text-field>
            </v-col>
          ...
          <v-row>
            ...
            <v-col cols="6">
              <v-select
                ...
                :items="['Not started', 'Design', 'Dev', 'Test']"
              ></v-select>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col cols="6">
              <v-select
                label="Screen SA"
                v-model="selectedSA"
                :items="filterUsersByPosition('System Analyst')"
                item-text="name"
                item-value="id"
                multiple
                chips
            ...
            <v-col cols="6">
              <v-select
                label="Screen Dev"
                v-model="selectedDev"
                :items="filterUsersByPosition('Developer')"
                item-text="name"
                item-value="id"
                multiple
                chips
          ...
          <v-row>
            <v-col cols="6">
              <v-select
                label="Screen Imp"
                v-model="selectedImp"
                :items="filterUsersByPosition('Implementer')"
                item-text="name"
                item-value="id"
                multiple
                chips
          ...
          <v-card-actions class="button">
            ...
            <v-btn color="#d33" class="white--text" @click="cancelForm"
              >Cancel</v-btn
            >
          </v-card-actions>
        </v-form>
