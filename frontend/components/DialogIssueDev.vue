                        ...
                        <v-col cols="6">
                            <v-row>
                                ...
                                <v-text-field label="Issue Name" placeholder="Issue Name" outlined dense
                                    v-model="IssueName" disabled></v-text-field>
                            </v-row>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12">
                            <v-textarea solo name="input-7-4" label="Note" v-model="IssueDes" style="" disabled></v-textarea></v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="6">
                            <v-row>
            ...
            <v-row class="pa-5">
                <v-col>
                    ...
                    <v-row>
                        <v-col cols="6">
                            <p class="">Cause / Remedy</p>
                            <v-textarea solo name="input-7-4" label="Note" v-model="IssueDesImplementer" disabled></v-textarea>
                        </v-col>
                    </v-row>
                </v-col>
            </v-row>
