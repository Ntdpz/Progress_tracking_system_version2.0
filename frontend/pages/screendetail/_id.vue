            ...
            <v-row no-gutters>
                <v-col col="12" sm="12" md="12">
                    <v-card class="mt-0" outlined tile style="box-shadow: none; border: none;">
                        <v-card-title>
                            <v-btn icon :to="`/systemdetail/${screensID.system_id}`" class="mr-4" color="primary"
                                size="35px" left>
                        ...
                        <v-container fluid>
                            ...
                            <v-row>
                                ...
                                <v-col class="col-12" sm="8" md="8">
                                    <v-text-field style="text-align-last: center;" v-model="screensID.screen_id"
                            ...
                            <v-row>
                                ...
                                <v-col class="col-12" sm="8" md="8">
                                    <v-text-field style="text-align-last: center;" v-model="screensID.screen_developer"
                                        hide-details="auto" dense outlined></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                            ...
                            <v-row>
                                ...
                                <v-col class="col-12" sm="8" md="8">
                                    <v-text-field style="text-align-last: center;" v-model="screensID.screen_implementer"
                                        hide-details="auto" dense outlined></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                            ...
                            <v-row>
                                ...
                                <v-col sm="4" md="4">
                                    <template>
                                        <v-text-field style="text-align-last: center;" v-model="screensID.screen_status"
                                ...
                                <v-col sm="4" md="4">
                                    <v-text-field style="text-align-last: center;" v-model="screensID.screen_level"
                                        hide-details="auto" dense outlined></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                            ...
                            <v-row>
                                ...
                                <v-col class="col-10" sm="4" md="4">
                                    <v-text-field style="text-align-last: center;" v-model="screensID.screen_manday"
                                        hide-details="auto" dense outlined></v-text-field>
                                </v-col>
