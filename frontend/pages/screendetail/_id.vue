    ...
    <div>
        ...
        <v-container>
            ...
            <v-row no-gutters>
                ...
                <v-col col="6" sm="6" md="6">
                    <v-card outlined tile height="430px">
                        <v-container fluid>
                            <v-row>
                            ...
                            <v-row>
                                <v-col cols="2" style="place-self: center;">
                                    <h5 class="">Status</h5>
                                </v-col>
                                <v-col cols="4">
                                    <template>
                            ...
                            <v-row>
                                <v-col cols="3" style="place-self: center;">
                                    <h5 class="">Manday</h5>
                                </v-col>
                                <v-col cols="4">
                            ...
                            <!--  -->
                            <v-btn to="#" class="mr-2" elevation="2" color="primary" bottom right absolute
