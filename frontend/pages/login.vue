                    ...
                    <v-flex style="text-align: -webkit-center;">
                        <v-card class="elevation-12" height="420px" width="400px">
                            <v-toolbar style="display: initial;">
                                <v-toolbar-title class="font-weight-bold ml-2 mt-3"
                                    style="font-size:30px;">Login</v-toolbar-title>
                            </v-toolbar>
                            <v-card-text>
                                <v-form>
                                    <v-text-field :rules="rules" label="Employee ID."
                                        placeholder="Enter your employee ID." type="text" outlined></v-text-field>
                                    <v-text-field :rules="rules" label="Password"
                                        placeholder="Enter 6 charactor or more" type="password" outlined></v-text-field>
                                </v-form>

                                <v-checkbox v-model="checkbox" class="mt-0" :label="`Remember Me`"></v-checkbox>
                            </v-card-text>
                            <v-btn style="color: white; font-weight: bold; height: 43px;" color="#883CFE" width="90%"
                                @click="(checkcountlogin())">Login</v-btn>
                        </v-card>
                            ...
                            <v-dialog v-model="dialog" persistent max-width="400px" max-height="600px">
                                <v-card class="pt-4 pb-4">
                                    <v-card-title class="pt-4 pb-4 "
                                        style="place-content: center; font-size:24px; font-weigth:bold;">
                                        บัญชีของคุณถูกล็อก
                                    </v-card-title>
                                    ...
                                    <v-card-actions class="pb-4">
                                        <v-btn style="place-content: center; color: white;" color="red"
                                            @click="dialog = false" width="100%">
                                            ติดต่อแอดมิน
                                        </v-btn>
                                    </v-card-actions>
                                </v-card>
