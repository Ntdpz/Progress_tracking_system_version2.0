  ...
  <div>
    <v-row class="mb-3">
      ...
      <v-text-title
        ...
        style="font-weight: bold; font-size: 20px"
      >
        {{ system.nameTH }} ({{ system.shortname }})
      </v-text-title>
    </v-row>
    <v-container style="padding-right: 30%">
      <v-row>
        ...
        <v-col cols="12" sm="6" md="6">
          <p>คำอธิบายถึง SA</p>
          <v-textarea solo name="input-7-4" label="คำอธิบายถึง SA"></v-textarea>
        </v-col>
        <v-col cols="12" class="mt-0">
          <v-textarea solo name="input-7-4" label="คำอธิบายปัญหา"></v-textarea>
        </v-col>
        <v-col cols="12">
          <v-file-input
            ref="fileInput"
